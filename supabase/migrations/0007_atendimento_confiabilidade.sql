...
--
-- Nota sobre "resultado incerto do provedor" (levantado na revisão): o
-- adaptador simulado de hoje é síncrono — não existe timeout ambíguo,
-- o resultado (enviada/falha) é conhecido na hora. Esse risco é real
-- pra um provedor de verdade (timeout sem saber se a mensagem chegou),
-- não pra este. Documentado aqui pra não ser esquecido quando um
-- adaptador real entrar: a interface de provedor precisa aceitar
-- idempotency_key como parâmetro do envio, pra provedores que suportem
-- dedup do lado deles.
--
-- Pré-condição: 0001-0006 aplicadas.
