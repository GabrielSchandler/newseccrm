-- copiado de supabase/migrations/0008_atendimento_conversas_external_id.sql — cole isso no SQL Editor do Supabase de homologação e rode.
--
...
--
-- Pre-condicao: 0001-0007 ja aplicadas (0007 aplicada em 24/09/2026).
