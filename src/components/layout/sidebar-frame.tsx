    ...
    <>
      <div className="border-b border-slate-200 bg-white px-4 py-3 md:hidden">
        <details className="group">
          <summary className="flex cursor-pointer list-none items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm font-semibold text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600">
            <span className="flex min-w-0 items-center gap-3">
              {companyLogoUrl ? (
                ...
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-900 px-2 text-center text-[11px] font-bold uppercase tracking-wide text-white">
          ...
          <div className="mt-3 space-y-3 pb-2">
            <Link
              ...
              className="inline-flex w-full items-center gap-3 rounded-lg bg-slate-950 px-3 py-3 text-sm font-semibold text-white transition hover:bg-teal-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2"
            >
      ...
      <aside className="hidden min-h-screen w-72 flex-col border-r border-slate-200 bg-white px-4 py-5 shadow-[8px_0_30px_rgba(15,23,42,0.04)] md:flex">
        <div className="rounded-lg border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-3">
          <div className="flex items-center gap-3">
            {companyLogoUrl ? (
              ...
              <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-slate-950 px-2 text-center text-sm font-bold uppercase tracking-wide text-white">
                {companyName.slice(0, 2)}
              </div>
            )}
          ...
          <div className="flex flex-1 flex-col gap-4">
            <div className="px-2">
              <Link
                ...
                className="inline-flex w-full items-center gap-3 rounded-lg bg-slate-950 px-3 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2"
              >
                <House aria-hidden="true" className="h-4 w-4" />
                Tela inicial
              </Link>
