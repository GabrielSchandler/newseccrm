...
export function buildGrsEmailSignatureHtml(options: SignatureOptions) {
  ...
  const email = escapeHtml(options.senderEmail || "administrativo@grssolucao.com.br");
...
<table cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;color:#111111;">
  <tr>
    <td style="padding:0 18px 0 0;vertical-align:middle;">
      <div style="font-size:34px;line-height:32px;font-weight:800;letter-spacing:0;color:#050505;">GRS</div>
      <div style="font-size:18px;line-height:19px;font-weight:800;letter-spacing:0;color:#e31b23;">SOLU&Ccedil;&Otilde;ES</div>
    </td>
    ...
    <td style="padding:0 0 0 18px;vertical-align:middle;">
      ...
      <div style="margin-top:8px;font-size:13px;line-height:20px;color:#111111;">
        ...
        <div><span style="color:#e31b23;font-weight:700;">E-mail</span> ${email}</div>
        <div><span style="color:#e31b23;font-weight:700;">Instagram</span> @grssolucao</div>
        <div><span style="color:#111111;font-weight:700;">Site</span> www.grssolucao.com.br</div>
      </div>
    </td>
  </tr>
</table>`;
