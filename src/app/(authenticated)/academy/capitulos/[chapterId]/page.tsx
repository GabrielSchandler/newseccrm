...
export default async function AcademyChapterPage({
  ...
  const nextChapter = getNextAcademyChapter(chapter.id);
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-950">{chapter.estimatedMinutes} min</p>
              </div>
            </div>
            <div className="mt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-950">
                  {academyCourse.passingScore}% ou mais
                </p>
              </div>
            </div>
          </div>
          ...
          <aside className="space-y-4">
            ...
            <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Registre a nota de conclusao deste capitulo. O gestor acompanha
            ...
            {status?.approved && nextChapter ? (
              <Link
                href={`/academy/capitulos/${nextChapter.id}`}
